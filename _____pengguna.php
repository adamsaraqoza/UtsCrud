<?php
include_once('_____headerUs.php');
...
<!-- modal -->
<form action="_____modalUs.php" method="post">
   ...
   <tbody>
      ...
      if($stmt->rowCount() > 0){
          while($row = $stmt->fetch(PDO::FETCH_OBJ)){
            ...
            <td>
               <a href=_____viewRamUS.php?id=<?php echo $row->id;?> class="btn btn-success btn-xs" >View</a>
...
<?php
include_once('_____footerUs.php');
 ?>
