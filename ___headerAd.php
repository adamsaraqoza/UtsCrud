...
<head>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="_assets/plugins/summernote/summernote-bs4.css">
...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <!-- Notifications Dropdown Menu -->
        ...
        <a href="logout.php"><i class="fas fa-th-small">Logout</i></a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Adam UTS</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="___penggunaAd.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="___isiAd.php" class="nav-link">
