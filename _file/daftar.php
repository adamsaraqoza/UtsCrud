...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Silahkan</b> Register!!!</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Belum Punya Akun Silahkan Daftar Dahulu!</p>

      <form action="proses.php" method="post">

      <div class="input-group mb-3">
          <input type="text" class="form-control" name="nik" placeholder="N I K" >
      ...
      <div class="input-group mb-3">
          <input type="text" class="form-control" name="namaa" placeholder="Nama Lengkap" >
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-envelope"></span>
            </div>
        ...
        <input type="submit" name="daftar" value="Daftar"  class="btn btn-block btn-danger">
